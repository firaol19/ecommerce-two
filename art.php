...
$art_product = "SELECT * FROM all_products WHERE group_id = 2";
$all_art = $conn->query($art_product);
$sql_cart = "SELECT * FROM cart";
$all_cart = $conn->query($sql_cart);


$paint = "SELECT * FROM all_products WHERE group_id = 2 AND category_id = 1";
$all_paint = $conn->query($paint);
$craft = "SELECT * FROM all_products WHERE group_id = 2 AND category_id = 2";
$all_craft = $conn->query($craft);
$fabric = "SELECT * FROM all_products WHERE group_id = 2 AND category_id = 3";
$all_fabric = $conn->query($fabric);
$party = "SELECT * FROM all_products WHERE group_id = 2 AND category_id = 4";
$all_party = $conn->query($party);
$gift = "SELECT * FROM all_products WHERE group_id = 2 AND category_id = 5";
$all_gift = $conn->query($gift );
$needle = "SELECT * FROM all_products WHERE group_id = 2 AND category_id = 6";
$all_needle = $conn->query($needle);
...
<body>
    <header class="header">
        ...
        <section class="bottom_header">
            ...
            <div class="search">
                ...
                <li  class="hiden-list"><a href="art.php" class="active">Art & Crafts</a></li>
    ...
    <main>
        <div class="category_nav" id="mover">
            <ul>
                    <li><a href="art.php" >Main</a></li>
                    <li><a href="#" id="tab1" class="tab_btn" onclick="moveLeft()">Painting and Drawing</a></li>
                    <li><a href="#" id="tab2" class="tab_btn" onclick="moveLeft()">Crafts</a></li>
                    <li><a href="#" id="tab3" class="tab_btn" onclick="moveLeft()">Fabric Decoration</a></li>
                    <li><a href="#" id="tab4" class="tab_btn" onclick="moveLeft()">Party Decoration</a></li>
                    <li><a href="#" id="tab5" class="tab_btn" onclick="moveLeft()">Gift Wrapping</a></li>
                    <li><a href="#" id="tab6" class="tab_btn" onclick="moveLeft()">Needle work</a></li>
            </ul>
        ...
        <section> 
            <div class="clothes_content container tab-item active-tabs" content >
                ...
                <?php
                while($row_cloth = mysqli_fetch_assoc($all_art)){
            ...
            <div class="clothes_content container tab-item " content id="men-cloth">
                <div class="clothes_container">
                <?php
                while($row_cloth1 = mysqli_fetch_assoc($all_paint)){
            ...
            <div class="clothes_content container tab-item " content id="women-cloth" >
                <div class="clothes_container">
                <?php
                while($row_cloth2 = mysqli_fetch_assoc($all_craft)){
            ...
            <div class="clothes_content container tab-item " content id="women-t-shirt" >
                <div class="clothes_container">
                <?php
                while($row_cloth3 = mysqli_fetch_assoc($all_fabric)){
            ...
            <div class="clothes_content container tab-item " content id="men-t-shirt" >
                <div class="clothes_container">
                <?php
                while($row_cloth4 = mysqli_fetch_assoc($all_party)){
            ...
            <div class="clothes_content container tab-item " content id="women-hoody" >
                <div class="clothes_container">
                <?php
                while($row_cloth5 = mysqli_fetch_assoc($all_gift)){
            ...
            <div class="clothes_content container tab-item " content id="children-cloth" >
                <div class="clothes_container">
                <?php
                while($row_cloth6 = mysqli_fetch_assoc($all_needle)){
