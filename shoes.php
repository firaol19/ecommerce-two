...
$clothes_product = "SELECT * FROM all_products WHERE group_id = 7";
$all_clothes = $conn->query($clothes_product);
$sql_cart = "SELECT * FROM cart";
$all_cart = $conn->query($sql_cart);


$men_clothes = "SELECT * FROM all_products WHERE group_id = 7 AND category_id = 1";
$all_men_clothes = $conn->query($men_clothes);
$women_clothes = "SELECT * FROM all_products WHERE group_id = 7 AND category_id = 2";
$all_women_clothes = $conn->query($women_clothes);
$women_shirt = "SELECT * FROM all_products WHERE group_id = 7 AND category_id = 3";
$all_women_shirt = $conn->query($women_shirt);
$men_shirt = "SELECT * FROM all_products WHERE group_id = 7 AND category_id = 4";
$all_men_shirt = $conn->query($men_shirt);
$women_hoody = "SELECT * FROM all_products WHERE group_id = 7 AND category_id = 5";
...
<body>
    <header class="header">
        ...
        <section class="bottom_header">
            ...
            <div class="search">
                ...
                <li  class="hiden-list"><a href="shoes.php" class="active">Shoes</a></li>
    ...
    <main>
        <div class="category_nav" id="mover">
            <ul>
                    <li><a href="shoes.php" >Main</a></li>
                    <li><a href="#" id="tab1" class="tab_btn" onclick="moveLeft()">Men`s Shoes</a></li>
                    <li><a href="#" id="tab2" class="tab_btn" onclick="moveLeft()">Women`Shoes </a></li>
                    <li><a href="#" id="tab3" class="tab_btn" onclick="moveLeft()">Children Shoes</a></li>
                    <li><a href="#" id="tab4" class="tab_btn" onclick="moveLeft()">Sport Shoes</a></li>
                    <li><a href="#" id="tab5" class="tab_btn" onclick="moveLeft()">Garden Shoes</a></li>
            </ul>
