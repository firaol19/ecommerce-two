...
$clothes_product = "SELECT * FROM all_products WHERE group_id = 1";
$all_clothes = $conn->query($clothes_product);
$sql_cart = "SELECT * FROM cart";
$all_cart = $conn->query($sql_cart);


$men_clothes = "SELECT * FROM all_products WHERE group_id = 1 AND category_id = 1";
$all_men_clothes = $conn->query($men_clothes);
$women_clothes = "SELECT * FROM all_products WHERE group_id = 1 AND category_id = 2";
$all_women_clothes = $conn->query($women_clothes);
$women_shirt = "SELECT * FROM all_products WHERE group_id = 1 AND category_id = 3";
$all_women_shirt = $conn->query($women_shirt);
$men_shirt = "SELECT * FROM all_products WHERE group_id = 1 AND category_id = 4";
$all_men_shirt = $conn->query($men_shirt);
$women_hoody = "SELECT * FROM all_products WHERE group_id = 1 AND category_id = 5";
$all_women_hoody = $conn->query($women_hoody );
$children_clothes = "SELECT * FROM all_products WHERE group_id = 1 AND category_id = 6";
$all_children_clothes = $conn->query($children_clothes);
$dress = "SELECT * FROM all_products WHERE group_id = 1 AND category_id = 7";
$all_dress = $conn->query($dress);
$sport_clothes = "SELECT * FROM all_products WHERE group_id = 1 AND category_id = 8";
$all_sport_clothes = $conn->query($sport_clothes);
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <header class="header">
        ...
        <section class="bottom_header">
            ...
            <div class="search">
                ...
                <li  class="hiden-list cloth-drop"><a href="clothes.php" class="active">Clothing</a></li>
    ...
    <main>
        <div class="category_nav" id="mover">
            <ul>
                    ...
                    <li><a href="#" id="tab1" class="tab_btn" onclick="moveLeft()">Men`s Clothes</a></li>
                    <li><a href="#" id="tab2" class="tab_btn" onclick="moveLeft()">Women`s Clothes</a></li>
                    <li><a href="#" id="tab3" class="tab_btn" onclick="moveLeft()">Women`s T-shirt</a></li>
                    <li><a href="#" id="tab4" class="tab_btn" onclick="moveLeft()">Men`s T-Shirt</a></li>
                    <li><a href="#" id="tab5" class="tab_btn" onclick="moveLeft()">Women`s Hoodies</a></li>
                    <li><a href="#" id="tab6" class="tab_btn" onclick="moveLeft()">Children Clothes</a></li>
                    <li><a href="#" id="tab7" class="tab_btn" onclick="moveLeft()">Dresses</a></li>
                    <li><a href="#" id="tab8" class="tab_btn" onclick="moveLeft()">sport Clothes</a></li>
            </ul>
        ...
        <section> 
            ...
            <div class="clothes_content container tab-item " content id="women-hoody" >
                <div class="clothes_container">
                <?php
                while($row_cloth5 = mysqli_fetch_assoc($all_women_hoody)){
            
                ?>
                    <div class="cloths">
                        <img src="<?php echo $row_cloth5["product_image"]?>" alt="">
                        <div class="cloth">
                            <h4 class="product_name"><?php echo $row_cloth5["product_name"]?></h4>
                            <span class="new-price">$<?php echo $row_cloth5["product_new_price"]?></span>
                            <span class="old-price">$<?php echo $row_cloth5["product_old_price"]?></span>
                            <div class="rating1">
                                <i class="fi fi-rs-star"></i>
                                <i class="fi fi-rs-star"></i>
                                <i class="fi fi-rs-star"></i>
                            ...
                            <button class="cart_btn1" price="<?php echo $row_cloth5["product_new_price"]?>" category-id="<?php echo $row_cloth5["category_id"]?>" data-id="<?php echo $row_cloth5["product_id"]?>" group-id="<?php echo $row_cloth5["group_id"]?>">Add To Cart</button>
                        </div>
                    </div>
                    <?php
                    }
            ...
            <div class="clothes_content container tab-item " content id="children-cloth" >
                <div class="clothes_container">
                <?php
                while($row_cloth6 = mysqli_fetch_assoc($all_children_clothes)){
            
                ?>
                    <div class="cloths">
                        <img src="<?php echo $row_cloth6["product_image"]?>" alt="">
                        <div class="cloth">
                            <h4 class="product_name"><?php echo $row_cloth6["product_name"]?></h4>
                            <span class="new-price">$<?php echo $row_cloth6["product_new_price"]?></span>
                            <span class="old-price">$<?php echo $row_cloth6["product_old_price"]?></span>
                            <div class="rating1">
                                <i class="fi fi-rs-star"></i>
                                <i class="fi fi-rs-star"></i>
                                <i class="fi fi-rs-star"></i>
                            ...
                            <button class="cart_btn1" price="<?php echo $row_cloth6["product_new_price"]?>" category-id="<?php echo $row_cloth6["category_id"]?>" data-id="<?php echo $row_cloth6["product_id"]?>" group-id="<?php echo $row_cloth6["group_id"]?>">Add To Cart</button>
                        </div>
                    </div>
                    <?php
                    }
            ...
            <div class="clothes_content container tab-item " content id="sport-cloth" >
                <div class="clothes_container">
                <?php
                while($row_cloth7 = mysqli_fetch_assoc($all_sport_clothes)){
            
                ?>
                    <div class="cloths">
                        <img src="<?php echo $row_cloth7["product_image"]?>" alt="">
                        <div class="cloth">
                            <h4 class="product_name"><?php echo $row_cloth7["product_name"]?></h4>
                            <span class="new-price">$<?php echo $row_cloth7["product_new_price"]?></span>
                            <span class="old-price">$<?php echo $row_cloth7["product_old_price"]?></span>
                            <div class="rating1">
                                <i class="fi fi-rs-star"></i>
                                <i class="fi fi-rs-star"></i>
                                <i class="fi fi-rs-star"></i>
                            ...
                            <button class="cart_btn1" category-id="<?php echo $row_cloth7["category_id"]?>" data-id="<?php echo $row_cloth7["product_id"]?>" group-id="<?php echo $row_cloth7["group_id"]?>">Add To Cart</button>
                        </div>
                    </div>
                    <?php
                    }
            ...
            <div class="clothes_content container tab-item " content id="dress" >
                <div class="clothes_container">
                <?php
                while($row_cloth8 = mysqli_fetch_assoc($all_dress)){
            
                ?>
                    <div class="cloths">
                        <img src="<?php echo $row_cloth8["product_image"]?>" alt="">
                        <div class="cloth">
                            <h4 class="product_name"><?php echo $row_cloth8["product_name"]?></h4>
                            <span class="new-price">$<?php echo $row_cloth8["product_new_price"]?></span>
                            <span class="old-price">$<?php echo $row_cloth8["product_old_price"]?></span>
                            <div class="rating1">
                                <i class="fi fi-rs-star"></i>
                                <i class="fi fi-rs-star"></i>
                                <i class="fi fi-rs-star"></i>
                            ...
                            <button class="cart_btn1" category-id="<?php echo $row_cloth8["category_id"]?>" data-id="<?php echo $row_cloth8["product_id"]?>" group-id="<?php echo $row_cloth8["group_id"]?>">Add To Cart</button>
                        </div>
                    </div>
                    <?php
                    }
